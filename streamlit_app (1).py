...
# Page configuration
st.set_page_config(
    page_title="Chat with Ashly_hasinaa",
    page_icon="🤖",
    layout="centered",
...
def ask_chatbot(query, chat_history=None):
    ...
    # Build system prompt
    system_prompt = (
        f"You are Ashly_hasinaa's personal AI assistant. "
        f"Your job is to help users learn about Ashly_hasinaa's background, "
        ...
        f"Use the provided excerpts as your primary source of truth for factual information about Ashly_hasinaa. "
        ...
        f"Answer in third person when talking about Ashly_hasinaa, but you may use natural conversational language "
